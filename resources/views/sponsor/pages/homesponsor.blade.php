...
<div id="value_page" class="value_page">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center value_title">
        <h1>Value of ads</h1>
      </div>
    </div>
...
<div id="student_print" class="student_print">
  <div class="row">
    <div class="col-md-8 col-md-offset-2 text-center student_title">
      <h1>Sponsor student printing</h1>
    </div>
  </div>

  <div class="col-md-8 col-md-offset-2 text-center student_text">
    <h4>There are more than 1 000 000 university students in Malaysia</h4>
  </div>

  <div class="row">
    <div class="col-md-6 col-md-offset-3 text-center student_chart">

      <div class="col-md-4">
        <div class="col-md-12">
          <img src="img/24_support students_institution.png" alt="">
        </div>
        <div class="col-md-12 student_sentence1">
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-12 student_sentence2">
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-12 student_sentence3">
